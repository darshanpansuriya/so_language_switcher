...
/**
 * QuickBooks request to add a retail customer record
 * @var string
 */
define('QUICKBOOKS_RETAIL_ADD_CUSTOMER', 'RetailCustomerAdd');

/**
 * QuickBooks request to modify a retail customer record
 * @var string
 */
define('QUICKBOOKS_RETAIL_MOD_CUSTOMER', 'RetailCustomerMod');

/**
 * QuickBooks request to add a retail customer Invoice record
 * @var string
 */
define('QUICKBOOKS_RETAIL_ADD_INVOICE','RetailCustomerInvoiceAdd');

/**
 * QuickBooks request to modify a retail customer Invoice record
 * @var string
 */
define('QUICKBOOKS_RETAIL_MOD_INVOICE','RetailCustomerInvoiceMod');
