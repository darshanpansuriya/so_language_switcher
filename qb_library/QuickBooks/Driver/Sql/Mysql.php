...

{
...

	{
...

		{
			...
			$this->_conn = mysql_connect('localhost'. ':' . $port, 'soundort_app', 'C$~_O^T-6z+~', $new_link, $client_flags) or die('host: ' . 'localhost' . ', user: ' . 'soundort_app' . ', pass: XXXX, mysql_error(): ' . mysql_error());
...

		{
			...
			$this->_conn = mysql_connect('localhost', 'soundort_app', 'C$~_O^T-6z+~', $new_link, $client_flags) or die('host: ' . 'localhost' . ', user: ' . 'soundort_app' . ', pass: XXXX, mysql_error(): ' . mysql_error());
...

		{
			...
			$this->_conn = mysql_connect('localhost:/tmp/mysql5.sock'. ':' . $port, 'dbo562806560', '9bpSTW-_O@d!', $new_link, $client_flags) or die('host: ' . 'localhost:/tmp/mysql5.sock' . ', user: ' . 'dbo562806560' . ', pass: XXXX, mysql_error(): ' . mysql_error());
...

		{
			...
			$this->_conn = mysql_connect('localhost:/tmp/mysql5.sock', 'dbo562806560', '9bpSTW-_O@d!', $new_link, $client_flags) or die('host: ' . 'localhost:/tmp/mysql5.sock' . ', user: ' . 'dbo562806560' . ', pass: XXXX, mysql_error(): ' . mysql_error());
		...
		$tmp = mysql_select_db('soundort_app', $this->_conn) or die(mysql_error());
