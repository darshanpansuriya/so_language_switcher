...
$appurl = 'http://localhost/so/admin/qb_library/docs/fpm_web_connector.php';		// This *must* be httpS:// (path to your QuickBooks SOAP server)
$appsupport = 'http://localhost/so/admin'; 		// This *must* be httpS:// and the domain name must match the domain name above
