...
// p($customer_query->row,__LINE__,__FILE__);
			$this->customer_id = $customer_query->row['customer_id'];
			$this->firstname = $customer_query->row['firstname'];
			$this->lastname = $customer_query->row['lastname'];
			$this->email = $customer_query->row['email'];
	...
	public function getCustomerInfo(){
		$xid = $this->getId();
		$customer_query = $this->db->query("SELECT * FROM " . DB_PREFIX . "customer WHERE customer_id = '$xid'");
		if ($customer_query->num_rows) return $customer_query->row;
		else return false;
	}
