...
class ModelLocalisationStockStatus extends Model {
	...
	public function getStockStatuses($data = array()) {
		if ($data) {
			$sql = "SELECT * FROM stock_status WHERE language_id = '" . (int)$this->config->get('config_language_id') . "'";
			...
			if (!$stock_status_data) {
				$query = $this->db->query("SELECT stock_status_id, stock_status_name FROM stock_status ORDER BY stock_status_name");
