...
class ModelSaleLab extends Model {
	...
	public function addOrderHistory($order_id, $data) {
		...
		if ((int) $data['order_status_id'] == 30) {
			...
			// if $day = date(februrary 15 2021) then add another weekday
	...
	public function getOrders($data = array()) {
		...
		// james updated filter status to show between 30 and 140
		if (isset($data['filter_status']) && !is_null($data['filter_status'])) {
			$sql .= "
					AND o.order_status_id = '" . (int) $data['filter_status'] . "'";
		} else {
			$sql .= "
					AND o.order_status_id > '25' AND o.order_status_id < '150'";
		}
