      ...
      <div id="tab_option">
        <table class="form">
          ...
          <tr>
            ...
            <td><?php if ($clinic_price) { ?>
              <input type="radio" name="clinic_price" value="1" checked="checked" />
              <?php echo $text_yes; ?>
              <input type="radio" name="clinic_price" value="0" />
              <?php echo $text_no; ?>
              <?php } else { ?>
              <input type="radio" name="clinic_price" value="1" />
              <?php echo $text_yes; ?>
              <input type="radio" name="clinic_price" value="0" checked="checked" />
              <?php echo $text_no; ?>
              <?php } ?></td>
          </tr>
          <tr>
            <td><?php echo $entry_clinic_approval; ?></td>
            <td><?php if ($clinic_approval) { ?>
              <input type="radio" name="clinic_approval" value="1" checked="checked" />
              <?php echo $text_yes; ?>
              <input type="radio" name="clinic_approval" value="0" />
              <?php echo $text_no; ?>
              <?php } else { ?>
              <input type="radio" name="clinic_approval" value="1" />
              <?php echo $text_yes; ?>
              <input type="radio" name="clinic_approval" value="0" checked="checked" />
              <?php echo $text_no; ?>
              <?php } ?></td>
          </tr>
          <tr>
