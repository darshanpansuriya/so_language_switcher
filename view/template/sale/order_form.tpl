...
if (isset($_SESSION['s_print1page_fr']) && $_SESSION['s_print1page_fr']) {

	echo "<script>window.open('hc_scripts/french_pdf_file.php?oid=$order_id','_blank','height=600,width=700,top=200,left=300,resizable');</script>";

	unset($_SESSION['s_print1page_fr']);

}

if (isset($_SESSION['s_printworkorder']) && $_SESSION['s_printworkorder']) {
// print "session is set";
	echo "<script>window.open('hc_scripts/workorder_pdf_file.php?oid=$order_id','_blank','height=600,width=700,top=200,left=300,resizable');</script>";

	unset($_SESSION['s_printworkorder']);
...
<!--		<input type="hidden" name="order_id" value="<?php echo $order_id; ?>"/>-->
		<input type="hidden" value="<?php echo $order_id; ?>" name="selected[]" id="orderidx" />
...
<form action="" class="cmxform" method="post"
	...
	<div class="h1float">
		...
		<h1>
			...
			<?php echo ($route == 'sale/order/insert' || !isset($order_id) || !$order_id? $heading_place:$heading_update)?>

			<strong><?php echo $heading_order; ?></strong>
	...
	<div class="toptext">
		...
		<table cellspacing="0">
			...
			<tr>
				...
				<td><span class="toptitle"><?php echo $tv_order_date; ?></span> <?php echo $order_date_added?$this->hc_functions->ch_date($order_date_added):date('Y-M-d');?>
				...
				<td><span class="toptitle"><?php echo $tv_status; ?></span> <?php echo $statusn;?></td>
	...
	<div class="lefttabs" id="tabs">
		...
		<a tab="#tab_patient_info" id="a_patient_info"
			...
			<div <?php if(isset($error_1) && $error_1) echo " class='red'";?>><?php echo $left_tabs_patient_info; ?></div> </a> <a tab="#tab_ortho_type" id="a_ortho_type"

			onclick="do_my_tabs(this);"><span>2</span>

			<div <?php if(isset($error_2) && $error_2) echo " class='red'";?>><?php echo $left_tabs_ortho_type; ?></div> </a> <a tab="#tab_mods" id="a_mods"

			onclick="do_my_tabs(this);"><span>3</span>

			<div <?php if(isset($error_3) && $error_3) echo " class='red'";?>><?php echo $left_tabs_mods; ?></div>

		</a> <a tab="#tab_additions" id="a_additions"

			onclick="do_my_tabs(this);"><span>4</span>

			<div <?php if(isset($error_4) && $error_4) echo " class='red'";?>><?php echo $left_tabs_additions; ?></div>

		</a> <a tab="#tab_posting" id="a_posting" onclick="do_my_tabs(this);"><span>5</span>

			<div <?php if(isset($error_5) && $error_5) echo " class='red'";?>><?php echo $left_tabs_posting; ?></div>

		</a> <a tab="#tab_covers" id="a_covers" onclick="do_my_tabs(this);"><span>6</span>

			<div <?php if(isset($error_6) && $error_6) echo " class='red'";?>><?php echo $left_tabs_covers; ?></div>

		</a> <a tab="#tab_delivery" id="a_delivery"

			onclick="do_my_tabs(this);"><span>7</span>

			<div <?php if(isset($error_7) && $error_7) echo " class='red'";?>><?php echo $left_tabs_delivery; ?></div>

		</a> <a tab="#tab_general" id="a_general" onclick="do_my_tabs(this);"><span>8</span>

			<div <?php if(isset($error_8) && $error_8) echo " class='red'";?>><?php echo $left_tabs_general; ?></div>

		</a> <a tab="#tab_files" id="a_files" onclick="do_my_tabs(this);"><span>9</span>

			<div <?php if(isset($error_9) && $error_9) echo " class='red'";?>><?php echo $left_tabs_files; ?></div>

		</a> <a tab="#tab_status" id="a_status" onclick="do_my_tabs(this);"><span>10</span>

			<div <?php if(isset($error_10) && $error_10) echo " class='red'";?>><?php echo $left_tabs_status; ?></div>
						...
						<div class="divleft">
							...
							<div class="ftitle">
								...
								<label><!--<span class="required">*</span>-->Date of birth:
									...
									value="<?php if($patient_dob != '0000-00-00' && $patient_dob != '1900-01-01') echo $patient_dob; ?>" autocomplete="off">
						...
						<div class="divleft">
							...
							<div class="ftitle">
								...
								<div class="information-icon"
									...
									<img src="/images/info.png" width="16px" height="16px">
					...
					<fieldset>
						...
						<div class="divleft">
							...
							<div class="ftitle">
								...
								// if ($time < "6") $day = date("Y-m-d",strtotime("+4 weekdays"));
								// else $day = date("Y-m-d",strtotime("+5 weekdays"));
							...
							<div class="ftitle">
								...
								<input type="text" name="order_date_needed"
									...
									onchange="rushDateCheck();" autocomplete="off" />
							...
							<div class="ftitle">
								...
								<label>Shipping Date (Lab Use Only):</label> <input type="text"
									...
									class="date" style="width: 130px" autocomplete="off" />
...
<!-- carbon fibre surcharge -->
								<tr>

									<td class="left" width="300px;">Carbon Fibre Shell Surcharge</td>

									<td class="left" width="150px;"><?php if (isset($carbon_fibre_shell_cost) && isset($order_quantity)){?>

										<label>$<?php echo sprintf('%0.2f', $carbon_fibre_shell_cost/$order_quantity); ?>

									</label> <?php }else{ echo '---';

									}?></td>

									<td class="left" width="150px;"><?php if(isset($carbon_fibre_shell_cost)) { ?>

										<label> $ <?php  echo $carbon_fibre_shell_cost; ?>
									...
									<td class="left" width="150px;"><?php if(isset($carbon_fibre_shell_tax)){ ?>

										<label> $ <?php echo $carbon_fibre_shell_tax; ?>
...
echo '(Left Only)';
		...
		<div id="filebuttons">
            ...
            <? if(in_array($user_group_string, array('1'))): ?>
						<a href="javascript:void();" onclick="print_1page_fr(<?php if ($this->user->stepFull($order_status_id)) echo 1; ?>)" class="bbutton bp"><p></p> <span>Impression<br />d'une Page </span> </a>

		<a href="javascript:void();" onclick="print_workorder(<?php if ($this->user->stepFull($order_status_id)) echo 1; ?>)" class="bbutton bp">
     <p></p><span>Work Order<br /> Print </span> </a>
	<? endif;  ?>
			<?php
...
// print_r($step);
	...
	<? endif;  ?>
	<? if(!in_array($user_group_string, array('1'))): ?>
	<a href="javascript:void();" onclick="print_1page_fr(<?php if ($this->user->stepFull($order_status_id)) echo 1; ?>)" class="bbutton bp">
		<p></p><span>Impression<br /> d'une Page </span> </a>
		<a href="javascript:void();" onclick="print_workorder(<?php if ($this->user->stepFull($order_status_id)) echo 1; ?>)" class="bbutton bp">
     <p></p><span>Work Order<br /> Print </span> </a>
	<? endif;  ?>
   <?php } ?>
