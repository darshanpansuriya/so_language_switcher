...
//EOF PAPs
		...
		$this->data['top_header_login'] = $this->language->get('top_header_login');
		$this->data['top_header_myaccount'] = $this->language->get('top_header_myaccount');
		$this->data['top_header_signout'] = $this->language->get('top_header_signout');
		$this->data['top_header_contact'] = $this->language->get('top_header_contact');

		// navigation
		$this->data['nav_home'] = $this->language->get('nav_home');
		$this->data['nav_orders'] = $this->language->get('nav_orders');
		$this->data['nav_users'] = $this->language->get('nav_users');
		$this->data['nav_clinics'] = $this->language->get('nav_clinics');
		$this->data['nav_patients'] = $this->language->get('nav_patients');
		$this->data['nav_reports'] = $this->language->get('nav_reports');

		// breadcrumbs
		$this->data['breadcrumbs_tracking'] = $this->language->get('breadcrumbs_tracking');
		$this->data['breadcrumbs_users'] = $this->language->get('breadcrumbs_users');
		$this->data['breadcrumbs_user_groups'] = $this->language->get('breadcrumbs_user_groups');
		$this->data['breadcrumbs_clinics'] = $this->language->get('breadcrumbs_clinics');
		$this->data['breadcrumbs_clinicians'] = $this->language->get('breadcrumbs_clinicians');
		$this->data['breadcrumbs_patients'] = $this->language->get('breadcrumbs_patients');
		$this->data['breadcrumbs_add_patient'] = $this->language->get('breadcrumbs_add_patient');
		...
		$this->data['text_clinic'] = $this->language->get('text_clinic');
		$this->data['text_clinic_group'] = $this->language->get('text_clinic_group');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['patient'] = HTTPS_SERVER . 'index.php?route=sale/patient&token=' . $this->session->data['token'];
			$this->data['clinic'] = HTTPS_SERVER . 'index.php?route=sale/clinic&token=' . $this->session->data['token'];
			$this->data['tracking'] = HTTPS_SERVER . 'index.php?route=common/tracking&token=' . $this->session->data['token'];
			...
			$this->data['lab-list'] = HTTPS_SERVER . 'index.php?route=sale/lab-list&token=' . $this->session->data['token'];
