	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			if(isset($this->request->post['where_am_i']) && $this->request->post['where_am_i']) {
				...
				$loc .= "+'&ortho_id=".$this->request->post['ortho_id'] . "'";
			}
...
//			$this->redirect(HTTPS_SERVER . 'index.php?route=setting/setting&token=' . $this->session->data['token']);
		...
		$this->data['entry_clinic_group'] = $this->language->get('entry_clinic_group');
		$this->data['entry_clinic_price'] = $this->language->get('entry_clinic_price');
		$this->data['entry_clinic_approval'] = $this->language->get('entry_clinic_approval');
...
*/		
		...
		if (isset($this->request->post['config_clinic_price'])) {
			$this->data['config_clinic_price'] = $this->request->post['config_clinic_price'];
		} else {
			$this->data['config_clinic_price'] = $this->config->get('config_clinic_price');			
		}
		
		if (isset($this->request->post['config_clinic_approval'])) {
			$this->data['config_clinic_approval'] = $this->request->post['config_clinic_approval'];
		} else {
			$this->data['config_clinic_approval'] = $this->config->get('config_clinic_approval');			
		}
		...
		if (isset($this->request->post['config_prebooked_status_id'])) {
			$this->data['config_prebooked_status_id'] = $this->request->post['config_prebooked_status_id'];
		} else {
			$this->data['config_prebooked_status_id'] = $this->config->get('config_prebooked_status_id');		
		}
		...
		if (isset($this->request->post['config_alert_broker'])) {
			$this->data['config_alert_broker'] = $this->request->post['config_alert_broker'];
		} else {
			$this->data['config_alert_broker'] = $this->config->get('config_alert_broker');
		}
		...
		/**
		 * this block is written to get the default taxation values
		 * @var unknown_type
		 */
		
		if (isset($this->request->post['tax_rate_hst'])) {
			$this->data['tax_rate_hst'] = $this->request->post['tax_rate_hst'];
		} else {
			$this->data['tax_rate_hst'] = $this->config->get('tax_rate_hst');
		}
		
		if (isset($this->request->post['tax_rate_pst'])) {
			$this->data['tax_rate_pst'] = $this->request->post['tax_rate_pst'];
		} else {
			$this->data['tax_rate_pst'] = $this->config->get('tax_rate_pst');			
		}
		
		if (isset($this->request->post['tax_rate_gst'])) {
			$this->data['tax_rate_gst'] = $this->request->post['tax_rate_gst'];
		} else {
			$this->data['tax_rate_gst'] = $this->config->get('tax_rate_gst');
		}
		
		if (isset($this->request->post['tax_rate_z'])) {
			$this->data['tax_rate_z'] = $this->request->post['tax_rate_z'];
		} else {
			$this->data['tax_rate_z'] = $this->config->get('tax_rate_z');
		}

		if (isset($this->request->post['short_code_1'])) {
			$this->data['short_code_1'] = $this->request->post['short_code_1'];
		} else {
			$this->data['short_code_1'] = $this->config->get('short_code_1');
		}
		
		if (isset($this->request->post['short_code_2'])) {
			$this->data['short_code_2'] = $this->request->post['short_code_2'];
		} else {
			$this->data['short_code_2'] = $this->config->get('short_code_2');
		}
		
		if (isset($this->request->post['short_code_3'])) {
			$this->data['short_code_3'] = $this->request->post['short_code_3'];
		} else {
			$this->data['short_code_3'] = $this->config->get('short_code_3');
		}
		if (isset($this->request->post['short_code_2'])) {
			$this->data['short_code_4'] = $this->request->post['short_code_4'];
		} else {
			$this->data['short_code_4'] = $this->config->get('short_code_4');
		}
		if (isset($this->request->post['short_code_5'])) {
			$this->data['short_code_5'] = $this->request->post['short_code_5'];
		} else {
			$this->data['short_code_5'] = $this->config->get('short_code_5');
		}
		if (isset($this->request->post['short_code_6'])) {
			$this->data['short_code_6'] = $this->request->post['short_code_6'];
		} else {
			$this->data['short_code_6'] = $this->config->get('short_code_6');
		}
		if (isset($this->request->post['short_code_7'])) {
			$this->data['short_code_7'] = $this->request->post['short_code_7'];
		} else {
			$this->data['short_code_7'] = $this->config->get('short_code_7');
		}
		if (isset($this->request->post['short_code_8'])) {
			$this->data['short_code_8'] = $this->request->post['short_code_8'];
		} else {
			$this->data['short_code_8'] = $this->config->get('short_code_8');
		}
		if (isset($this->request->post['short_code_9'])) {
			$this->data['short_code_9'] = $this->request->post['short_code_9'];
		} else {
			$this->data['short_code_9'] = $this->config->get('short_code_9');
		}
		if (isset($this->request->post['short_code_10'])) {
			$this->data['short_code_10'] = $this->request->post['short_code_10'];
		} else {
			$this->data['short_code_10'] = $this->config->get('short_code_10');
		}
		if (isset($this->request->post['short_code_11'])) {
			$this->data['short_code_11'] = $this->request->post['short_code_11'];
		} else {
			$this->data['short_code_11'] = $this->config->get('short_code_11');
		}
		if (isset($this->request->post['short_code_12'])) {
			$this->data['short_code_12'] = $this->request->post['short_code_12'];
		} else {
			$this->data['short_code_12'] = $this->config->get('short_code_12');
		}
		if (isset($this->request->post['short_code_13'])) {
			$this->data['short_code_13'] = $this->request->post['short_code_13'];
		} else {
			$this->data['short_code_13'] = $this->config->get('short_code_13');
		}
		if (isset($this->request->post['short_code_14'])) {
			$this->data['short_code_14'] = $this->request->post['short_code_14'];
		} else {
			$this->data['short_code_14'] = $this->config->get('short_code_14');
		}
		if (isset($this->request->post['short_code_15'])) {
			$this->data['short_code_15'] = $this->request->post['short_code_15'];
		} else {
			$this->data['short_code_15'] = $this->config->get('short_code_15');
		}
		if (isset($this->request->post['short_code_16'])) {
			$this->data['short_code_16'] = $this->request->post['short_code_16'];
		} else {
			$this->data['short_code_16'] = $this->config->get('short_code_16');
		}
		if (isset($this->request->post['short_code_17'])) {
			$this->data['short_code_17'] = $this->request->post['short_code_17'];
		} else {
			$this->data['short_code_17'] = $this->config->get('short_code_17');
		}
		if (isset($this->request->post['short_code_18'])) {
			$this->data['short_code_18'] = $this->request->post['short_code_18'];
		} else {
			$this->data['short_code_18'] = $this->config->get('short_code_18');
		}
		if (isset($this->request->post['short_code_19'])) {
			$this->data['short_code_19'] = $this->request->post['short_code_19'];
		} else {
			$this->data['short_code_19'] = $this->config->get('short_code_19');
		}
		if (isset($this->request->post['short_code_20'])) {
			$this->data['short_code_20'] = $this->request->post['short_code_20'];
		} else {
			$this->data['short_code_20'] = $this->config->get('short_code_20');
		}
		if (isset($this->request->post['short_code_21'])) {
			$this->data['short_code_21'] = $this->request->post['short_code_21'];
		} else {
			$this->data['short_code_21'] = $this->config->get('short_code_21');
		}
		if (isset($this->request->post['short_code_22'])) {
			$this->data['short_code_22'] = $this->request->post['short_code_22'];
		} else {
			$this->data['short_code_22'] = $this->config->get('short_code_22');
		}
		if (isset($this->request->post['short_code_23'])) {
			$this->data['short_code_23'] = $this->request->post['short_code_23'];
		} else {
			$this->data['short_code_23'] = $this->config->get('short_code_23');
		}
		if (isset($this->request->post['short_code_24'])) {
			$this->data['short_code_24'] = $this->request->post['short_code_24'];
		} else {
			$this->data['short_code_24'] = $this->config->get('short_code_24');
		}
		if (isset($this->request->post['short_code_25'])) {
			$this->data['short_code_25'] = $this->request->post['short_code_25'];
		} else {
			$this->data['short_code_25'] = $this->config->get('short_code_25');
		}
		if (isset($this->request->post['short_code_26'])) {
			$this->data['short_code_26'] = $this->request->post['short_code_26'];
		} else {
			$this->data['short_code_26'] = $this->config->get('short_code_26');
		}
		if (isset($this->request->post['short_code_27'])) {
			$this->data['short_code_27'] = $this->request->post['short_code_27'];
		} else {
			$this->data['short_code_27'] = $this->config->get('short_code_27');
		}
		if (isset($this->request->post['short_code_28'])) {
			$this->data['short_code_28'] = $this->request->post['short_code_28'];
		} else {
			$this->data['short_code_28'] = $this->config->get('short_code_28');
		}
		if (isset($this->request->post['short_code_29'])) {
			$this->data['short_code_29'] = $this->request->post['short_code_29'];
		} else {
			$this->data['short_code_29'] = $this->config->get('short_code_29');
		}
		
		/**
		 * getting and setting values for the tax rate types
		 */
		if (isset($this->request->post['tax_type_1'])) {
			$this->data['tax_type_1'] = $this->request->post['tax_type_1'];
		} else {
			$this->data['tax_type_1'] = $this->config->get('tax_type_1');
		}
		if (isset($this->request->post['tax_type_2'])) {
			$this->data['tax_type_2'] = $this->request->post['tax_type_2'];
		} else {
			$this->data['tax_type_2'] = $this->config->get('tax_type_2');
		}
		if (isset($this->request->post['tax_type_3'])) {
			$this->data['tax_type_3'] = $this->request->post['tax_type_3'];
		} else {
			$this->data['tax_type_3'] = $this->config->get('tax_type_3');
		}
		if (isset($this->request->post['tax_type_4'])) {
			$this->data['tax_type_4'] = $this->request->post['tax_type_4'];
		} else {
			$this->data['tax_type_4'] = $this->config->get('tax_type_4');
		}
		if (isset($this->request->post['tax_type_5'])) {
			$this->data['tax_type_5'] = $this->request->post['tax_type_5'];
		} else {
			$this->data['tax_type_5'] = $this->config->get('tax_type_5');
		}
		if (isset($this->request->post['tax_type_6'])) {
			$this->data['tax_type_6'] = $this->request->post['tax_type_6'];
		} else {
			$this->data['tax_type_6'] = $this->config->get('tax_type_6');
		}
		if (isset($this->request->post['tax_type_7'])) {
			$this->data['tax_type_7'] = $this->request->post['tax_type_7'];
		} else {
			$this->data['tax_type_7'] = $this->config->get('tax_type_7');
		}
		if (isset($this->request->post['tax_type_8'])) {
			$this->data['tax_type_8'] = $this->request->post['tax_type_8'];
		} else {
			$this->data['tax_type_8'] = $this->config->get('tax_type_8');
		}
		if (isset($this->request->post['tax_type_9'])) {
			$this->data['tax_type_9'] = $this->request->post['tax_type_9'];
		} else {
			$this->data['tax_type_9'] = $this->config->get('tax_type_9');
		}
		if (isset($this->request->post['tax_type_10'])) {
			$this->data['tax_type_10'] = $this->request->post['tax_type_10'];
		} else {
			$this->data['tax_type_10'] = $this->config->get('tax_type_10');
		}
		if (isset($this->request->post['tax_type_11'])) {
			$this->data['tax_type_11'] = $this->request->post['tax_type_11'];
		} else {
			$this->data['tax_type_11'] = $this->config->get('tax_type_11');
		}
		if (isset($this->request->post['tax_type_12'])) {
			$this->data['tax_type_12'] = $this->request->post['tax_type_12'];
		} else {
			$this->data['tax_type_12'] = $this->config->get('tax_type_12');
		}
		if (isset($this->request->post['tax_type_13'])) {
			$this->data['tax_type_13'] = $this->request->post['tax_type_13'];
		} else {
			$this->data['tax_type_13'] = $this->config->get('tax_type_13');
		}
		if (isset($this->request->post['tax_type_14'])) {
			$this->data['tax_type_14'] = $this->request->post['tax_type_14'];
		} else {
			$this->data['tax_type_14'] = $this->config->get('tax_type_14');
		}
		if (isset($this->request->post['tax_type_15'])) {
			$this->data['tax_type_15'] = $this->request->post['tax_type_15'];
		} else {
			$this->data['tax_type_15'] = $this->config->get('tax_type_15');
		}
		if (isset($this->request->post['tax_type_16'])) {
			$this->data['tax_type_16'] = $this->request->post['tax_type_16'];
		} else {
			$this->data['tax_type_16'] = $this->config->get('tax_type_16');
		}
		if (isset($this->request->post['tax_type_17'])) {
			$this->data['tax_type_17'] = $this->request->post['tax_type_17'];
		} else {
			$this->data['tax_type_17'] = $this->config->get('tax_type_17');
		}
		if (isset($this->request->post['tax_type_18'])) {
			$this->data['tax_type_18'] = $this->request->post['tax_type_18'];
		} else {
			$this->data['tax_type_18'] = $this->config->get('tax_type_18');
		}
		if (isset($this->request->post['tax_type_19'])) {
			$this->data['tax_type_19'] = $this->request->post['tax_type_19'];
		} else {
			$this->data['tax_type_19'] = $this->config->get('tax_type_19');
		}
		if (isset($this->request->post['tax_type_20'])) {
			$this->data['tax_type_20'] = $this->request->post['tax_type_20'];
		} else {
			$this->data['tax_type_20'] = $this->config->get('tax_type_20');
		}
		
		if (isset($this->request->post['tax_type_21'])) {
			$this->data['tax_type_21'] = $this->request->post['tax_type_21'];
		} else {
			$this->data['tax_type_21'] = $this->config->get('tax_type_21');
		}
		
		if (isset($this->request->post['tax_type_22'])) {
			$this->data['tax_type_22'] = $this->request->post['tax_type_22'];
		} else {
			$this->data['tax_type_22'] = $this->config->get('tax_type_22');
		}
		
		if (isset($this->request->post['tax_type_23'])) {
			$this->data['tax_type_23'] = $this->request->post['tax_type_23'];
		} else {
			$this->data['tax_type_23'] = $this->config->get('tax_type_23');
		}
		
		if (isset($this->request->post['tax_type_24'])) {
			$this->data['tax_type_24'] = $this->request->post['tax_type_24'];
		} else {
			$this->data['tax_type_24'] = $this->config->get('tax_type_24');
		}
		
		if (isset($this->request->post['tax_type_25'])) {
			$this->data['tax_type_25'] = $this->request->post['tax_type_25'];
		} else {
			$this->data['tax_type_25'] = $this->config->get('tax_type_25');
		}
		
		if (isset($this->request->post['tax_type_26'])) {
			$this->data['tax_type_26'] = $this->request->post['tax_type_26'];
		} else {
			$this->data['tax_type_26'] = $this->config->get('tax_type_26');
		}
		
		if (isset($this->request->post['tax_type_27'])) {
			$this->data['tax_type_27'] = $this->request->post['tax_type_27'];
		} else {
			$this->data['tax_type_27'] = $this->config->get('tax_type_27');
		}
		
		
		if (isset($this->request->post['tax_type_28'])) {
			$this->data['tax_type_28'] = $this->request->post['tax_type_28'];
		} else {
			$this->data['tax_type_28'] = $this->config->get('tax_type_28');
		}
		
		if (isset($this->request->post['tax_type_29'])) {
			$this->data['tax_type_29'] = $this->request->post['tax_type_29'];
		} else {
			$this->data['tax_type_29'] = $this->config->get('tax_type_29');
		}	
	...
	/**
	 * function responsible for the default updates to the database tables for settings
	 */
	public function updateItemPricingDefaults(){
	
		$this->load->model('setting/setting');
	
	
		if (isset($this->request->get['ortho_id'])) {
			$orthotic_id =  $this->request->get['ortho_id'];
		}
		...
		if (isset($this->request->get['item_value'])) {
			$item_price =  $this->request->get['item_value'];
		}
	
		// calling the model function to update  the values in the database
		echo $this->model_setting_setting->updateItemPricingDefaultValues($orthotic_id,$item_id,$item_price);
	}
	
	public function updateSettingPricing(){
		...
		echo $this->model_setting_setting->updateSettingPricingValues($orthotic_id,$price_1,$price_2,$price_3,$price_4,$price_5,$price_6,$price_7,$price_8,$price_9,$price_10,$price_11,$price_12);
