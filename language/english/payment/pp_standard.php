...
$_['entry_order_status_failed']				= 'Order Status Failed:<br /><span class="help">The payment has failed. This will only happen if the payment was attempted from your clinics bank account.</span>';
$_['entry_order_status_refunded']			= 'Order Status Refunded:<br /><span class="help">You, the merchant, refunded the payment.</span>';
$_['entry_order_status_canceled_reversal']	= 'Order Status Canceled Reversal:<br /><span class="help">This means a reversal has been canceled; for example, you, the merchant, won a dispute with the clinic and the funds for the transaction that was reversed have been returned to you.</span>';
$_['entry_order_status_reversed']			= 'Order Status Reversed:<br /><span class="help">This means that a payment was reversed due to a chargeback or other type of reversal. The funds have been debited from your account balance and returned to the clinic. The reason for the reversal is given by the reason_code variable.</span>';
