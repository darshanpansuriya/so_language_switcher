...
$_['entry_clinic_group']    = 'Price Group:<br /><span class="help">Default price group.</span>';
$_['entry_clinic_price']    = 'Login Display Prices:<br /><span class="help">Only show prices when a clinic is logged in.</span>';
$_['entry_clinic_approval'] = 'Approve New Clinics:<br /><span class="help">Don\'t allow new clinic to login until their account has been approved.</span>';
$_['entry_guest_checkout']    = 'Guest Checkout:<br /><span class="help">Allow clinics to checkout without creating an account. This will not be available when a downloadable product is in the shopping cart.</span>';
$_['entry_account']           = 'Account Terms:<br /><span class="help">Forces people to agree to terms before an account can be created.</span>';
$_['entry_checkout']          = 'Checkout Terms:<br /><span class="help">Forces people to agree to terms before an a clinic can checkout.</span>';
...
$_['entry_stock_checkout']    = 'Stock Checkout:<br /><span class="help">Allow clinics to still checkout if the products they are ordering are not in stock.</span>';
...
$_['entry_download_status']   = 'Download Order Status:<br /><span class="help">Set the order status the clinics order must reach before they are allowed to access their downloadable products.</span>';
...
$_['entry_admin_limit']   	  = 'Default Items per Page (Admin):<br /><span class="help">Determines how many admin items are shown per page (orders, clinics, etc)</span>';
...
$_['entry_maintenance']       = 'Maintenance Mode:<br /><span class="help">Prevents clinics from browsing your store. They will instead see a maintenance message. If logged in as admin, you will see the store as normal.</span>';
